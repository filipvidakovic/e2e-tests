...
public class ElementStateExample {
	...
	public void elementGetTextExample() {
		...
		WebElement siteNotice = driver.findElement(By.className("title"));
	...
	public void elementGetTagNameExample() {
		...
		WebElement element = driver.findElement(By.className("control"));

		System.out.println("Html tag with class 'control' is: " + element.getTagName());
	}
