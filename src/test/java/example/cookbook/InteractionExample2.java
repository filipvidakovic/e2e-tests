...
public class InteractionExample2 {
	...
	public void shouldDrag() {
		...
		actions.dragAndDropBy(dragMe, 150, 0).perform();
	}
	...
	public void shouldDragAndDrop() {
		...
		String textBeforeDrop = trgt.getText();

		Actions actions = new Actions(driver);
		actions.dragAndDrop(src, trgt).perform();

		String textAfterDrop = trgt.getText();

		assertNotEquals(textBeforeDrop, textAfterDrop);
	}
